...
class TestBubbleSortFlexpret(TestFlexpretBackend):
    config_path = "./programs/bubblesort/config.yaml"
    
class TestBitMaskFlexpret(TestFlexpretBackend):
    config_path = "./gametime_examples/bitmask/config.yaml"
...
if __name__ == '__main__':
    ...
    suite.addTests(loader.loadTestsFromTestCase(TestBubbleSortFlexpret))
    #suite.addTests(loader.loadTestsFromTestCase(TestBitMaskFlexpret))
